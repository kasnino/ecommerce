  ...
  <section class="product" style="background: #F5F5F5;">
    ...
    <div class="row bg-white mx-0">
      <div class="col-3" style="border:1px solid #efefef;    display: flex; justify-content: space-evenly;">
        <img :src="spanish" alt="" style="width:18px">
        <img :src="arrow_right" alt="" style="width:10px">
      </div>
      <div class="col-3 px-0 p-4 text-center" :class="{'text-dark':sex=='Mujer'}" @click="sex='Mujer'" style="border:1px solid #efefef;font-weight: 700;
font-size: 14px;
line-height: 17px;
color: #CCCCCC;">Mujer</div>
      <div class="col-3 px-0 p-4 text-center" :class="{'text-dark':sex=='Hombre'}" @click="sex='Hombre'" style="border:1px solid #efefef;font-weight: 700;
font-size: 14px;
line-height: 17px;
color: #CCCCCC;">Hombre</div>
      <div class="col-3 px-0 p-4 text-center" :class="{'text-dark':sex=='Infantil'}" @click="sex='Infantil'" style="border:1px solid #efefef;border-right:0px; font-weight: 700;
font-size: 14px;
line-height: 17px;
    ...
    <div class="row px-0 mx-0">
      <div class="col-12 text-center">
        <div class="input-group mb-3">
          ...
          <input type="text" class="form-control search-cat"  style="background:#EAEAEA;height: 50px;border-color:#EAEAEA;" placeholder="Buscar marcas, artículos y más..." aria-label="Username" aria-describedby="basic-addon1">
        </div>
      </div>
    </div>
 
    <HeadBandOnly :data="{title:'CATEGORIAS'}" :icon="(sex=='Mujer')?female:((sex=='Hombre')?male:children)" />
...
import female from '../assets/generos/female_black.svg';
